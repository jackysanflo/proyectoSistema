...
public class Main extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        Node pivot2 = new Node("nodo_pivoteMarte");
        Node pivot3 = new Node("nodo_pivoteJupiter");
    ...
    public void simpleUpdate(float tpf) {
        ...
        **/
        ...
        // tpf/2 indica que se movera un medio de la velocidad que lo haga el nodo tierra
        //gira en el eje Y
        rootNode.getChild("nodo_pivoteMarte").rotate(tpf/2,0 , 0);
      
        
        
        // tpf/1 indica que se movera una vez de la velocidad que lo haga el nodo tierra
        //gira en el eje Z
        rootNode.getChild("nodo_pivoteJupiter").rotate(0,0,tpf*1);
